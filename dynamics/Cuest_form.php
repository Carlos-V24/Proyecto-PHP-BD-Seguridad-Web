<?php
//se solitan los datos correspondientes en cada uno de las clientes pertinentes

function Solicitar_NCuent(){//Alumnos
...
function Solicitar_RFC(){//Todo tipo de trabajador
...
function Solicitar_NTrab(){//Todo tipo de trabajador
...
function Solicitar_Usu(){//Todo tipo de usuario
...
function Solicitar_Admin(){//Empleados de la cafeteria
...
function Solicitar_Nom(){//Todo tipo de usuario
...
function Solicitar_Apell_P(){//Todo tipo de usuario
...
function Solicitar_Apell_M(){//Todo tipo de usuario
...
function Solicitar_Psw(){//Todo tipo de usuario
...
function Solicitar_Psw_Rpt(){//Todo tipo de usuario
