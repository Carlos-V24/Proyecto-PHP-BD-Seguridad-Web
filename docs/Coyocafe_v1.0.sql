...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `pedidos_ibfk_2` FOREIGN KEY (`id_alimento`) REFERENCES `alimento` (`id_alimento`),
  CONSTRAINT `pedidos_ibfk_3` FOREIGN KEY (`id_entrega`) REFERENCES `lugar_entrega` (`id_lugar_entrega`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-05-26 10:31:23
